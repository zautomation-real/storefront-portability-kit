...
export function renderProductPreview(brand, product, catalog = { products: [] }) {
  ...
  const optionPresentations = JSON.stringify(productOptionPresentations(product)).replaceAll("<", "\\u003c");
